/*
 * voodoo_sound.c  --  WCD9310 ALSA Soc Audio driver related
 *
...
#define SUBJECT "WCD9310_voodoo.c"

#ifdef MODULE
#include "wcd9310_voodoo_sound.h"

// WCD9310_write -> tegrak_WCD9310_write for dynamic link
#ifdef WCD9310_write
#undef WCD9310_write
#endif

// WCD9310_read -> tegrak_WCD9310_read for dynamic link
#ifdef WCD9310_read
#undef WCD9310_read
#endif

#define WCD9310_write(codec, reg, value) WCD9310_write(codec, reg, value)
#define WCD9310_read(codec, reg) WCD9310_read(codec, reg)
#endif
...
#define DECLARE_WCD9310(codec) struct WCD9310_priv *WCD9310 = \
		snd_soc_codec_get_drvdata(codec);
#else
#define DECLARE_WCD9310(codec) struct WCD9310_priv *WCD9310 = codec->private_data;
#endif
...
void write_hpvol(unsigned short l, unsigned short r)
{
	...
	val = (WCD9310_HPOUT1L_MUTE_N | l);
	val |= WCD9310_HPOUT1L_ZC;
	WCD9310_write(codec, WCD9310_LEFT_OUTPUT_VOLUME, val);

	// this time we write the right volume plus the Volume Update flag.
	// This way, both volume are set at the same time
	val = (WCD9310_HPOUT1_VU | WCD9310_HPOUT1R_MUTE_N | r);
	val |= WCD9310_HPOUT1L_ZC;
	WCD9310_write(codec, WCD9310_RIGHT_OUTPUT_VOLUME, val);
}
...
void update_hpvol(bool with_fade)
{
	...
	short steps;
	int hp_level_old[2];
	unsigned short hp_level_registers[2] = { WCD9310_LEFT_OUTPUT_VOLUME,
						 WCD9310_RIGHT_OUTPUT_VOLUME };

	DECLARE_WCD9310(codec);

	// don't affect headphone amplifier volume
	// when not on heapdhones or if call is active
	if (!is_path(HEADPHONES)
	    || (WCD9310->codec_state & CALL_ACTIVE))
		return;
	...
	for (i = 0; i < 2; i++) {
		val = WCD9310_read(codec, hp_level_registers[i]);
		val &= ~(WCD9310_HPOUT1_VU_MASK);
		val &= ~(WCD9310_HPOUT1L_ZC_MASK);
		val &= ~(WCD9310_HPOUT1L_MUTE_N_MASK);
...
void update_fm_radio_headset_restore_freqs(bool with_mute)
{
	...
	if (WCD9310->fmradio_path == FMR_OFF)
		return;

	if (with_mute) {
		WCD9310_write(codec, WCD9310_AIF2_DAC_FILTERS_1,
			     WCD9310_AIF2DAC_MUTE |
			     WCD9310_AIF2DAC_MUTERATE |
			     WCD9310_AIF2DAC_UNMUTE_RAMP |
			     WCD9310_AIF2DAC_DEEMP_MASK);
		msleep(180);
	}
	...
	if (fm_radio_headset_restore_bass) {
		...
		WCD9310_write(codec, WCD9310_SIDETONE, 0x0000);
		// disable 4FS ultrasonic mode and
		// restore the hi-fi <4Hz hi pass filter
		WCD9310_write(codec, WCD9310_AIF2_ADC_FILTERS,
			     WCD9310_AIF2ADCL_HPF |
			     WCD9310_AIF2ADCR_HPF);
	} else {
		// default settings in GT-I9000 Froyo XXJPX kernel sources
		WCD9310_write(codec, WCD9310_SIDETONE, 0x01c0);
		WCD9310_write(codec, WCD9310_AIF2_ADC_FILTERS, 0xF800);
	}

	if (fm_radio_headset_restore_highs) {
		val = WCD9310_read(codec, WCD9310_AIF2_DAC_FILTERS_1);
		val &= ~(WCD9310_AIF2DAC_DEEMP_MASK);
		WCD9310_write(codec, WCD9310_AIF2_DAC_FILTERS_1, val);
	} else {
		WCD9310_write(codec, WCD9310_AIF2_DAC_FILTERS_1, 0x0036);
	}

	// un-mute
	if (with_mute) {
		val = WCD9310_read(codec, WCD9310_AIF2_DAC_FILTERS_1);
		val &= ~(WCD9310_AIF2DAC_MUTE_MASK);
		WCD9310_write(codec, WCD9310_AIF2_DAC_FILTERS_1, val);
	}
	bypass_write_hook = false;
}
...
void update_fm_radio_headset_normalize_gain(bool with_mute)
{
	...
	if (fm_radio_headset_normalize_gain) {
		...
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_3_4_VOLUME, 0x52);
		WCD9310_write(codec, WCD9310_RIGHT_LINE_INPUT_3_4_VOLUME, 0x152);
		WCD9310_write(codec, WCD9310_AIF2_DRC_2, 0x0840);
		WCD9310_write(codec, WCD9310_AIF2_DRC_3, 0x2408);
		WCD9310_write(codec, WCD9310_AIF2_DRC_4, 0x0082);
		WCD9310_write(codec, WCD9310_AIF2_DRC_5, 0x0100);
		WCD9310_write(codec, WCD9310_AIF2_DRC_1, 0x019C);
	} else {
		// Original volume, change with Zero Cross
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_3_4_VOLUME, 0x4B);
		WCD9310_write(codec, WCD9310_RIGHT_LINE_INPUT_3_4_VOLUME, 0x14B);
		WCD9310_write(codec, WCD9310_AIF2_DRC_2, 0x0840);
		WCD9310_write(codec, WCD9310_AIF2_DRC_3, 0x2400);
		WCD9310_write(codec, WCD9310_AIF2_DRC_4, 0x0000);
		WCD9310_write(codec, WCD9310_AIF2_DRC_5, 0x0000);
		WCD9310_write(codec, WCD9310_AIF2_DRC_1, 0x019C);
	}
	bypass_write_hook = false;
}
...
void update_recording_preset(bool with_mute)
{
	...
	case 0:
		...
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME,
			     WCD9310_IN1L_VU | origin_recgain);
		WCD9310_write(codec, WCD9310_INPUT_MIXER_3, origin_recgain_mixer);
		// DRC disabled
		WCD9310_write(codec, WCD9310_AIF1_DRC1_1, 0x0080);
		break;
	case 2:
		// High sensitivy:
		// Original - 4.5 dB, IN1L_VOL1=10101 (+15 dB)
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME, 0x0115);
		WCD9310_write(codec, WCD9310_INPUT_MIXER_3,
			     WCD9310_IN1L_TO_MIXINL |
			     WCD9310_IN1L_MIXINL_VOL);
		// DRC Input: -6dB, Ouptut -3.75dB
		//     Above knee 1/8, Below knee 1/2
		//     Max gain 24 / Min gain -12
		WCD9310_write(codec, WCD9310_AIF1_DRC1_1,
			     WCD9310_AIF1DRC1_SIG_DET_MODE |
			     WCD9310_AIF1DRC1_QR |
			     WCD9310_AIF1DRC1_ANTICLIP |
			     WCD9310_AIF1ADC1L_DRC_ENA);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_2, 0x0426);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x0019);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x0105);
		break;
	case 3:
		// Concert new: IN1L_VOL1=10110 (+4.5 dB)
		// +30dB input mixer gain deactivated
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME, 0x010F);
		WCD9310_write(codec, WCD9310_INPUT_MIXER_3,
		             WCD9310_IN1L_TO_MIXINL);
		...
		WCD9310_write(codec, WCD9310_AIF1_DRC1_1,
			     ...
			     WCD9310_AIF1DRC1_ANTICLIP |
			     WCD9310_AIF1ADC1L_DRC_ENA);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_2, 0x0846);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x0011);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x00C9);
		break;
	case 4:
		// ULTRA LOUD:
		// Original - 36 dB - 30 dB IN1L_VOL1=00000 (-16.5 dB)
		// +30dB input mixer gain deactivated
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME, 0x0100);
		WCD9310_write(codec, WCD9310_INPUT_MIXER_3,
		             WCD9310_IN1L_TO_MIXINL);
		...
		WCD9310_write(codec, WCD9310_AIF1_DRC1_1,
			     ...
			     WCD9310_AIF1DRC1_ANTICLIP |
			     WCD9310_AIF1ADC1L_DRC_ENA);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_2, 0x0847);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x001A);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x00C9);
		break;
	default:
		...
		// +30dB input mixer gain deactivated
		WCD9310_write(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME, 0x055D);
		WCD9310_write(codec, WCD9310_INPUT_MIXER_3,
		             WCD9310_IN1L_TO_MIXINL);
		...
		WCD9310_write(codec, WCD9310_AIF1_DRC1_1,
			     ...
			     WCD9310_AIF1DRC1_ANTICLIP |
			     WCD9310_AIF1ADC1L_DRC_ENA);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_2, 0x0845);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x0019);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x030C);
		break;
	}
}
#endif
...
bool is_path(int unified_path)
{
	...
	// speaker
	case SPEAKER:
		return (WCD9310->cur_path == SPK
			|| WCD9310->cur_path == SPK_HP);

	// headphones
	case HEADPHONES:
		return (WCD9310->cur_path == HP3P
			|| WCD9310->cur_path == HP4P
			|| WCD9310->fmradio_path == FMR_HP);
	...
	case MAIN_MICROPHONE:
		return (WCD9310->codec_state & CAPTURE_ACTIVE)
		    && (WCD9310->rec_path == MAIN)
		    && !(WCD9310->codec_state & CALL_ACTIVE);
...
bool is_path_media_or_fm_no_call_no_record()
{
	...
	if ((is_path(HEADPHONES)
	     && (WCD9310->codec_state & PLAYBACK_ACTIVE)
	     && (WCD9310->stream_state & PCM_STREAM_PLAYBACK)
	     && !(WCD9310->codec_state & CALL_ACTIVE)
	     && (WCD9310->rec_path == MIC_OFF)
...
void update_speaker_tuning(bool with_mute)
{
	...
	if (!(is_path(SPEAKER) || (WCD9310->codec_state & CALL_ACTIVE)))
		return;

	if (speaker_tuning) {
		// DRC settings
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x0010);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x00EB);

		// hardware EQ
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_1,   0x041D);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_2,   0x4C00);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_A,  0x0FE3);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_B,  0x0403);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_PG, 0x0074);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_A,  0x1F03);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_B,  0xF0F9);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_C,  0x040A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_PG, 0x03DA);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_A,  0x1ED2);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_B,  0xF11A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_C,  0x040A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_PG, 0x045D);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_4_A,  0x0E76);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_4_B,  0xFCE4);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_4_C,  0x040A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_4_PG, 0x330D);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_5_A,  0xFC8F);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_5_B,  0x0400);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_5_PG, 0x323C);

		// Speaker Boost tuning
		WCD9310_write(codec, WCD9310_CLASSD,                 0x0170);
	} else {
		// DRC settings
		WCD9310_write(codec, WCD9310_AIF1_DRC1_3, 0x0028);
		WCD9310_write(codec, WCD9310_AIF1_DRC1_4, 0x0186);

		// hardware EQ
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_1,   0x0019);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_2,   0x6280);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_A,  0x0FC3);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_B,  0x03FD);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_1_PG, 0x00F4);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_A,  0x1F30);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_B,  0xF0CD);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_C,  0x040A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_2_PG, 0x032C);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_A,  0x1C52);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_B,  0xF379);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_C,  0x040A);
		WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_BAND_3_PG, 0x0DC1);
		WCD9310_write(codec, WCD9310_CLASSD,                 0x0170);

		// Speaker Boost tuning
		WCD9310_write(codec, WCD9310_CLASSD,                 0x0168);
	}
}
#endif
...
{
	if (dac_osr128 == 1)
		val |= WCD9310_DAC_OSR128;
	else
		val &= ~WCD9310_DAC_OSR128;

	if (adc_osr128 == 1)
		val |= WCD9310_ADC_OSR128;
	else
		val &= ~WCD9310_ADC_OSR128;
...
{
	unsigned short val;
	val = osr128_get_value(WCD9310_read(codec, WCD9310_OVERSAMPLING));
	bypass_write_hook = true;
	WCD9310_write(codec, WCD9310_OVERSAMPLING, val);
	bypass_write_hook = false;
}
...
{
	val = (val >> WCD9310_FLL1_GAIN_WIDTH << WCD9310_FLL1_GAIN_WIDTH);
	if (fll_tuning == 1)
		val |= 5;
...
{
	unsigned short val;
	val = fll_tuning_get_value(WCD9310_read(codec, WCD9310_FLL1_CONTROL_4));
	bypass_write_hook = true;
	WCD9310_write(codec, WCD9310_FLL1_CONTROL_4, val);
	bypass_write_hook = false;
}
#endif
...
void update_mono_downmix(bool with_mute)
{
	...
	val1 = mono_downmix_get_value(WCD9310_read
				      (codec, WCD9310_AIF1_DAC1_FILTERS_1),
				      true);
	val2 = mono_downmix_get_value(WCD9310_read
				      (codec, WCD9310_AIF1_DAC2_FILTERS_1),
				      true);
	val3 = mono_downmix_get_value(WCD9310_read
				      (codec, WCD9310_AIF2_DAC_FILTERS_1),
				      true);

	bypass_write_hook = true;
	WCD9310_write(codec, WCD9310_AIF1_DAC1_FILTERS_1, val1);
	WCD9310_write(codec, WCD9310_AIF1_DAC2_FILTERS_1, val2);
	WCD9310_write(codec, WCD9310_AIF2_DAC_FILTERS_1, val3);
	bypass_write_hook = false;
}
...
unsigned short dac_direct_get_value(unsigned short val, bool can_reverse)
{
	if (is_path_media_or_fm_no_call_no_record()) {
		...
		if (dac_direct) {
			if (val == WCD9310_DAC1L_TO_MIXOUTL)
				return WCD9310_DAC1L_TO_HPOUT1L;
		} else {
			if (val == WCD9310_DAC1L_TO_HPOUT1L && can_reverse)
				return WCD9310_DAC1L_TO_MIXOUTL;
		}
	}
...
void update_dac_direct(bool with_mute)
{
	...
	val1 = dac_direct_get_value(WCD9310_read(codec,
						WCD9310_OUTPUT_MIXER_1), true);
	val2 = dac_direct_get_value(WCD9310_read(codec,
						WCD9310_OUTPUT_MIXER_2), true);

	bypass_write_hook = true;
	WCD9310_write(codec, WCD9310_OUTPUT_MIXER_1, val1);
	WCD9310_write(codec, WCD9310_OUTPUT_MIXER_2, val2);
	bypass_write_hook = false;
}
...
{
	unsigned short val1, val2;
	val1 = digital_gain_get_value(WCD9310_read(codec,
						WCD9310_AIF1_DAC1_LEFT_VOLUME));
	val2 = digital_gain_get_value(WCD9310_read(codec,
						WCD9310_AIF1_DAC1_RIGHT_VOLUME));

	bypass_write_hook = true;
	WCD9310_write(codec, WCD9310_AIF1_DAC1_LEFT_VOLUME,
		     WCD9310_DAC1_VU | val1);
	WCD9310_write(codec, WCD9310_AIF1_DAC1_RIGHT_VOLUME,
		     WCD9310_DAC1_VU | val2);
	bypass_write_hook = false;
}
...
void update_headphone_eq(bool update_bands)
{
	...
	gains_1 =
	    ((eq_gains[0] + 12) << WCD9310_AIF1DAC1_EQ_B1_GAIN_SHIFT) |
	    ((eq_gains[1] + 12) << WCD9310_AIF1DAC1_EQ_B2_GAIN_SHIFT) |
	    ((eq_gains[2] + 12) << WCD9310_AIF1DAC1_EQ_B3_GAIN_SHIFT) |
	    headphone_eq;

	gains_2 =
	    ((eq_gains[3] + 12) << WCD9310_AIF1DAC1_EQ_B4_GAIN_SHIFT) |
	    ((eq_gains[4] + 12) << WCD9310_AIF1DAC1_EQ_B5_GAIN_SHIFT);

	WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_1, gains_1);
	WCD9310_write(codec, WCD9310_AIF1_DAC1_EQ_GAINS_2, gains_2);
...
void update_headphone_eq_bands()
{
	...
	int j;
	int k = 0;
	int first_reg = WCD9310_AIF1_DAC1_EQ_BAND_1_A;
...
void update_stereo_expansion(bool with_mute)
{
	...
	val = WCD9310_read(codec, WCD9310_AIF1_DAC1_FILTERS_2);
	if (stereo_expansion) {
		val &= ~(WCD9310_AIF1DAC1_3D_GAIN_MASK);
		val |= (stereo_expansion_gain << WCD9310_AIF1DAC1_3D_GAIN_SHIFT);
	}
	val &= ~(WCD9310_AIF1DAC1_3D_ENA_MASK);
	val |= (stereo_expansion << WCD9310_AIF1DAC1_3D_ENA_SHIFT);

	WCD9310_write(codec, WCD9310_AIF1_DAC1_FILTERS_2, val);
}
...
void load_current_eq_values()
{
	...
	for (i = 0; i < ARRAY_SIZE(eq_band_values); i++)
		for (j = 0; j < eq_bands[i]; j++) {
			eq_band_values[i][j] =
			    WCD9310_read(codec, first_reg + k);
			k++;
		}
}
...
void apply_saturation_prevention_drc()
{
	...
	val = WCD9310_read(codec, WCD9310_AIF1_DRC1_2);
	val &= ~(WCD9310_AIF1DRC1_ATK_MASK);
	val &= ~(WCD9310_AIF1DRC1_DCY_MASK);
	val |= (0x1 << WCD9310_AIF1DRC1_ATK_SHIFT);
	val |= (0x4 << WCD9310_AIF1DRC1_DCY_SHIFT);

	// set DRC maximum gain to 36 dB
	val &= ~(WCD9310_AIF1DRC1_MAXGAIN_MASK);
	val |= (0x3 << WCD9310_AIF1DRC1_MAXGAIN_SHIFT);

	WCD9310_write(codec, WCD9310_AIF1_DRC1_2, val);

	// Above knee: flat (what really avoid the saturation)
	val = WCD9310_read(codec, WCD9310_AIF1_DRC1_3);
	val |= (0x5 << WCD9310_AIF1DRC1_HI_COMP_SHIFT);
	WCD9310_write(codec, WCD9310_AIF1_DRC1_3, val);

	val = WCD9310_read(codec, WCD9310_AIF1_DRC1_1);
	// disable Quick Release and Anti Clip
	// both do do more harm than good for this particular usage
	val &= ~(WCD9310_AIF1DRC1_QR_MASK);
	val &= ~(WCD9310_AIF1DRC1_ANTICLIP_MASK);

	// enable DRC
	val &= ~(WCD9310_AIF1DAC1_DRC_ENA_MASK);
	val |= WCD9310_AIF1DAC1_DRC_ENA;
	WCD9310_write(codec, WCD9310_AIF1_DRC1_1, val);

	val = WCD9310_read(codec, WCD9310_AIF1_DRC1_4);
	val &= ~(WCD9310_AIF1DRC1_KNEE_IP_MASK);

	if (digital_gain >= 0) {
		// deal with positive digital gains
		i = ((digital_gain * 10 / step) + 5) / 10;
		drc_gain += i;
		val |= (drc_gain << WCD9310_AIF1DRC1_KNEE_IP_SHIFT);
	...
	WCD9310_write(codec, WCD9310_AIF1_DRC1_4, val);
}
...
static ssize_t show_WCD9310_register_dump(struct device *dev,
					 struct device_attribute *attr,
					 char *buf)
{
	// modified version of register_dump from WCD9310_aries.c
	// r = WCD9310 register
	int r;

	for (r = 0; r <= 0x6; r++)
		sprintf(buf, "%s0x%X 0x%X\n", buf, r, WCD9310_read(codec, r));

	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x15, WCD9310_read(codec, 0x15));

	for (r = 0x18; r <= 0x3C; r++)
		sprintf(buf, "%s0x%X 0x%X\n", buf, r, WCD9310_read(codec, r));

	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x4C, WCD9310_read(codec, 0x4C));

	for (r = 0x51; r <= 0x5C; r++)
		sprintf(buf, "%s0x%X 0x%X\n", buf, r, WCD9310_read(codec, r));

	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x60, WCD9310_read(codec, 0x60));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x101, WCD9310_read(codec, 0x101));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x110, WCD9310_read(codec, 0x110));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x111, WCD9310_read(codec, 0x111));
	...
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x510, WCD9310_read(codec, 0x510));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x520, WCD9310_read(codec, 0x520));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x521, WCD9310_read(codec, 0x521));
	...
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x620, WCD9310_read(codec, 0x620));
	sprintf(buf, "%s0x%X 0x%X\n", buf, 0x621, WCD9310_read(codec, 0x621));
...
static ssize_t store_WCD9310_write(struct device *dev,
				  struct device_attribute *attr,
				  const char *buf, size_t size)
{
...
#ifdef CONFIG_SND_VOODOO_DEVELOPMENT
static DEVICE_ATTR(WCD9310_register_dump, S_IRUGO,
		   show_WCD9310_register_dump,
		   NULL);

static DEVICE_ATTR(WCD9310_write, S_IWUSR,
		   NULL,
		   store_WCD9310_write);
#endif
...
#ifdef CONFIG_SND_VOODOO_DEVELOPMENT
	&dev_attr_WCD9310_register_dump.attr,
	&dev_attr_WCD9310_write.attr,
#endif
#ifdef MODULE
...
void voodoo_hook_WCD9310_pcm_remove()
{
...
void update_enable()
{
	if (enable) {
		...
		voodoo_hook_WCD9310_pcm_remove();
}
...
void voodoo_hook_record_main_mic()
{
	...
	origin_recgain = WCD9310_read(codec, WCD9310_LEFT_LINE_INPUT_1_2_VOLUME);
	origin_recgain_mixer = WCD9310_read(codec, WCD9310_INPUT_MIXER_3);
	update_recording_preset(false);
}
#endif
...
unsigned int voodoo_hook_WCD9310_write(struct snd_soc_codec *codec_,
				      unsigned int reg, unsigned int value)
{
	DECLARE_WCD9310(codec_);
	...
	if (!bypass_write_hook) {
		...
		if (is_path(HEADPHONES)
			...
			if (reg == WCD9310_LEFT_OUTPUT_VOLUME)
				value =
				    (WCD9310_HPOUT1_VU |
				     WCD9310_HPOUT1L_MUTE_N |
				     hpvol(0));

			if (reg == WCD9310_RIGHT_OUTPUT_VOLUME)
				value =
				    (WCD9310_HPOUT1_VU |
				     WCD9310_HPOUT1R_MUTE_N |
				     hpvol(1));
		}
#endif
		...
		if (is_path(RADIO_HEADPHONES)) {
			if (reg == WCD9310_AIF2_DRC_1
			    || reg == WCD9310_AIF2_DAC_FILTERS_1)
				voodoo_hook_fmradio_headset();
		}
#else
		// FM tuning virtual hook for Froyo
		if (is_path(RADIO_HEADPHONES)) {
			if (reg == WCD9310_INPUT_MIXER_2
			    || reg == WCD9310_AIF2_DRC_1
			    || reg == WCD9310_ANALOGUE_HP_1)
				voodoo_hook_fmradio_headset();
		}
#endif
#endif
		// global Oversampling tuning
		if (reg == WCD9310_OVERSAMPLING)
			value = osr128_get_value(value);

#ifndef GALAXY_TAB_TEGRA
		// global Anti-Jitter tuning
		if (reg == WCD9310_FLL1_CONTROL_4)
			value = fll_tuning_get_value(value);
#endif

		// global Mono downmix tuning
		if (reg == WCD9310_AIF1_DAC1_FILTERS_1
		    || reg == WCD9310_AIF1_DAC2_FILTERS_1
		    || reg == WCD9310_AIF2_DAC_FILTERS_1)
			value = mono_downmix_get_value(value, false);

		// DAC direct tuning virtual hook
		if (reg == WCD9310_OUTPUT_MIXER_1
		    || reg == WCD9310_OUTPUT_MIXER_2)
			value = dac_direct_get_value(value, false);

		// Digital Headroom virtual hook
		if (reg == WCD9310_AIF1_DAC1_LEFT_VOLUME
		    || reg == WCD9310_AIF1_DAC1_RIGHT_VOLUME)
	...
	// log every write to dmesg
		printk("Voodoo sound: WCD9310_write 0x%03X 0x%04X "
#ifdef NEXUS_S
		       "codec_state=%u, stream_state=%u, "
		       "cur_path=%i, rec_path=%i, "
		       "power_state=%i\n",
		       reg, value,
		       WCD9310->codec_state, WCD9310->stream_state,
		       WCD9310->cur_path, WCD9310->rec_path,
		       WCD9310->power_state);
#else
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 35)
		       "codec_state=%u, stream_state=%u, "
		       ...
		       WCD9310->codec_state, WCD9310->stream_state,
#if !defined(M110S) && !defined(GALAXY_TAB_TEGRA)
		       WCD9310->fmradio_path, WCD9310->fmr_mix_path,
#endif
		       WCD9310->cur_path, WCD9310->rec_path,
#ifndef GALAXY_TAB
		       WCD9310->input_source,
#endif
#if !defined(M110S) && !defined(GALAXY_TAB_TEGRA) && !defined(GALAXY_TAB)
		       WCD9310->output_source,
#endif
		       WCD9310->power_state);
#else
		       "codec_state=%u, stream_state=%u, "
...
#endif
#ifdef CONFIG_S5PC110_KEPLER_BOARD
		       WCD9310->call_record_path, WCD9310->call_record_ch,
		       WCD9310->AUDIENCE_state,
		       WCD9310->Fac_SUB_MIC_state, WCD9310->TTY_state,
#endif
		       WCD9310->power_state
#if !defined(M110S) && !defined(GALAXY_TAB_TEGRA)
		       ,WCD9310->recognition_active,
		       WCD9310->ringtone_active
#endif
		);
#endif
#endif
...
void voodoo_hook_WCD9310_pcm_probe(struct snd_soc_codec *codec_)
{
	enable = true;
	update_enable();
